...
entity Inquiries : managed {
  ...
  ValidFrom         : Date;
  ValidTo           : Date;
  Status            : String(20) default 'OPEN' @assert.range enum { OPEN; CONVERTED; CANCELLED; };
  Notes             : String(500);
...
entity Quotations : managed {
  ...
  Status            : String(20) default 'OPEN' @assert.range enum { OPEN; ACCEPTED; EXPIRED; REJECTED; };
...
entity SalesOrders : managed {
  ...
  Status            : String(20) default 'OPEN' @assert.range enum { OPEN; DELIVERY_CREATED; GOODS_ISSUED; INVOICED; COMPLETED; CANCELLED; };
...
entity OutboundDeliveries : managed {
  ...
  PlannedGIDate     : Date;
  ActualGIDate      : Date;
  GIStatus          : String(20) default 'PENDING' @assert.range enum { PENDING; PICKED; GOODS_ISSUED; };
...
entity BillingDocuments : managed {
  ...
  Currency          : String(3)  default 'INR';
  ARStatus          : String(20) default 'OPEN' @assert.range enum { OPEN; PARTIALLY_PAID; CLEARED; };
